...
<head>
    ...
    <script language="JavaScript" src="js/view_supplier.js"></script>
</head>
<body>
	<!-- TOP BAR -->
								...
								<form name="deletefiles" action="delete.php" method="post">
									...
									<?php
										...
										if (mysqli_connect_errno($con))
    									{
            								...
            								echo ' <th>Supplier Contact 1</th>';
            								echo ' <th>Supplier Contact 2</th>';
            								echo '<th>Debt Amount</th>';            
											echo '<th>Edit /Delete</th>';
                                			echo '<th>Select</th>';
        									echo ' </tr>';

    									$result = mysqli_query($con,"SELECT * FROM supplier_details");
